...
public class BossCucumber : MonoBehaviour
{
    //Declarations
    ...
    void Start()
    {
        ...
        InvokeRepeating("SpawnMiniCucumber", 20, 3);
    }
    ...
    private void JumpPrecipice()
    {
        ...
        enemyRigidbody2D.AddForce(new Vector2(6 * changeDirection, 6), ForceMode2D.Impulse);
    }
    ...
    private void SpawnMiniCucumber()
    {
        Instantiate(miniCucumber, transform.position, miniCucumber.transform.rotation);
        speedMovemen++;
    }
}
